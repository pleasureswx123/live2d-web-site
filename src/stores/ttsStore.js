...
export const useTTSStore = create((set, get) => {
  ...
  return {
    ...
    EXPRESSION_KEYWORDS: {
      ...
      'weiqu': ['委屈', '难过', '伤心', '呜呜', '好难过', '心疼', '好委屈', '心里难受'],
      'yanlei': ['哭', '眼泪', '流泪', '哭泣', '泪水', '呜呜呜', '哭哭', '好想哭'],
      'hahadaxiao': ['哈哈', '大笑', '笑死', '太好笑', '哈哈哈', '笑', '开心', '高兴', '快乐', '笑死我了', '太好笑了'],
      'jingya': ['惊讶', '什么', '怎么会', '不会吧', '天哪', '我的天', '震惊', '真的吗', '不敢相信'],
      'jingxi': ['惊喜', '太好了', '棒', '厉害', 'amazing', '太棒了', 'wonderful', '好棒', '真棒'],

      // 中等情感表情 - 中优先级
      'haixiu': ['害羞', '不好意思', '羞涩', '脸红红', '好害羞', '羞羞', '脸红'],
      'lianhong': ['脸红', '羞', '红脸', '害羞', '脸红了', '好羞'],
      'aojiao': ['傲娇', '得意', '骄傲', '哼', '才不是', '略略略', '哼', '才没有'],
      'tuosai': ['托腮', '思考', '想想', '让我想想', '嗯嗯', '考虑', '琢磨', '让我思考一下', '想想看'],
      'mimiyan': ['满足', '舒服', '嗯', '不错', '挺好', '还行', '满意', '舒服了'],
      'guilian': ['鬼脸', '做鬼脸', '扮鬼脸', '调皮', '捣蛋', '恶作剧'],
      'luolei': ['落泪', '掉眼泪', '泪流', '哭泣', '哭哭', '流泪'],

      // 动作相关表情 - 中优先级
      'baoxiong': ['叉腰', '抱胸', '叉着腰', '抱胸', '挺胸', '自信', '得意'],
      'chayao': ['叉腰', '叉着腰', '挺胸', '自信', '得意'],
      'jianpantaiqi': ['键盘', '打字', '敲键盘', '电脑', '工作', '编程', '码字'],

      // 电脑相关表情 - 中优先级
      'diannao': ['电脑', '计算机', '编程', '代码', '工作', '学习', '上网'],
      'diannaofaguang': ['电脑发光', '电脑亮', '屏幕亮', '显示器', '屏幕'],

      // 温和表情 - 低优先级（优先使用中性表情以支持口型同步）
